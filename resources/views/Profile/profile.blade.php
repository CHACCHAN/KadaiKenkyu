        ...
        <div class="col-3">
            <div class="mt-3">
                <div class="list-group list-group-flush">
                    <a href="{{ route('Profile.account') }}" class="list-group-item list-group-item-action @if(Request::is('profile/account')) 'list-group-item-secondary' @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                        </svg>&nbsp;&nbsp;Cアカウント
                    </a>
                    <a href="{{ route('Profile.secure') }}" class="list-group-item list-group-item-action @if(Request::is('profile/secure')) 'list-group-item-secondary' @endif">
                    ...
                    <a href="" class="list-group-item list-group-item-action @if(Request::is('profile/dashboard')) 'list-group-item-secondary' @endif">
                    ...
                    <a href="" class="list-group-item list-group-item-action @if(Request::is('profile/help')) 'list-group-item-secondary' @endif">
