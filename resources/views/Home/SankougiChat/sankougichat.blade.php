    ...
    <div id="row">
        ...
        <div class="col-md-3 d-none d-md-block position-fixed" style="left: 0;">
            @auth
                @if(!$sankougi_chat_user)
                    <div class="opacity-25 disable">
                @endif
                    <div class="list-group list-group-flush mt-3">
                        {{-- 掲示板ホーム --}}
                        <a href="#" class="list-group-item list-group-item-action h4">
                        ...
                        {{-- 投稿ボタン --}}
                        <button class="btn btn-primary mt-5 mx-2">
                            <div class="fs-5">
                                投稿する
                            </div>
                        </button>
        ...
        <div class="col-2 d-md-none position-fixed" style="left: 0;">
            <div class="list-group list-group-flush">
                {{-- 掲示板ホーム --}}
                <button type="button" class="list-group-item list-group-item-action h4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-chat-right-text-fill" viewBox="0 0 16 16">
                        <path d="M16 2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h9.586a1 1 0 0 1 .707.293l2.853 2.853a.5.5 0 0 0 .854-.353V2zM3.5 3h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1zm0 2.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1zm0 2.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1z"/>
                    </svg>
                </button>
        ...
        {{-- 中央コンテンツ --}}
        <div class="col-10 col-md-9 overflow-auto position-absolute bg-light border-start ps-3" style="right: 0;">
            aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>
            aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>
            aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>
            aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>
            aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>aaa<br>
