        ...
        <div class="col-md-3 d-none d-md-block position-fixed" style="left: 0;">
            ...
            @auth
                ...
                <div class="list-group list-group-flush mt-3">
                    ...
                    {{-- スレッド --}}
                    <a @if(isset($sankougi_chat_none_user))href="{{ route('Home.sankougichat.thread') }}"@endif class="list-group-item h4 @if(Request::is('sankougichat/thread') || Request::is('sankougichat/thread/*')) list-group-item-secondary @endif">
                    ...
                    {{-- 検索 --}}
                    <a @if(isset($sankougi_chat_none_user))href="{{ route('Home.sankougichat.search') }}"@endif class="list-group-item h4 @if(Request::is('sankougichat/search') || Request::is('sankougichat/search/*')) list-group-item-secondary @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                        </svg>   検索する
                    </a>
                    {{-- 友だちリスト --}}
                    <a @if(isset($sankougi_chat_none_user))href="{{ route('Home.sankougichat.friend') }}"@endif class="list-group-item h4 @if(Request::is('sankougichat/friend') || request::is('sankougichat/friend/*')) list-group-item-secondary @endif">
